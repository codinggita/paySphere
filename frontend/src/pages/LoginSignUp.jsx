  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col font-sans">
      <div className="flex-1 flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-6xl bg-white rounded-3xl shadow-xl flex overflow-hidden min-h-[600px]">

          {/* LEFT PANEL */}
          <div className="w-[42%] bg-gradient-to-br from-indigo-50 via-red-50 to-yellow-100 p-10 flex flex-col justify-between relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-500 text-sm max-w-xs leading-relaxed">
                Experience the digital ledger for modern Bharat. Run payroll in 3 clicks.
              </p>
            </div>

            {/* stat card */}
            <div className="bg-white rounded-xl p-5 shadow-md relative z-10">
              <p className="text-sm text-gray-500 mb-2">Last Month Payout</p>
              <h2 className="text-2xl font-serif text-gray-900">₹12,45,000</h2>
            </div>
          </div>
      ...
      {/* footer */}
      <div className="text-center text-xs text-gray-400 font-semibold py-4 uppercase tracking-wider">
