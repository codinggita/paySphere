        ...
        <section className="px-6 pb-24 overflow-hidden">
            <div className="max-w-6xl mx-auto relative">
                <div className="relative rounded-[2.5rem] border border-gray-200 bg-gray-50/50 p-4 shadow-2xl animate-in fade-in zoom-in duration-1000">
                    ...
                    <div className="absolute -bottom-10 -right-4 md:-right-12 bg-white/90 backdrop-blur-xl p-6 rounded-2xl shadow-2xl border border-white/50 max-w-[280px] hidden sm:block animate-in slide-in-from-right-10 duration-1000 delay-500">
